'''
    ...
    1. Принимает список заметок (каждая заметка — это словарь).
    2. Отображает каждую заметку в удобном и понятном формате.
'''
...
def display_notes(notes):
    ...
    while i != len(notes):
        ...
        print("Описание: ", notes[i]['Описание'])
        print("Статус: ", notes[i]['Статус'])
        print("Дата создания: ", notes[i]['Дата создания'])
        print("Дедлайн: ", notes[i]['Дата дедлайн'])
